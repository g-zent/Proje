...
net=jetson.inference.imageNet('alexnet',['--model=/home/beu/jetson-inference/python/training/classification/myModel/resnet18.onnx','--input_blob=input_0','--output_blob=output_0','labels=/home/beu/İndirilenler/jetson-inference/myTrain/labels.txt'])
